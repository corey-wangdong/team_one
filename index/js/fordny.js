...
var total=$("#solid ul").children().length;
	 ...
	 $(document).ready(function() {
		...
		$("#btt span").eq(1).css("margin-left","30px");
		$("#btt span").eq(2).css("margin-left","60px");
		$("#btt span").eq(3).css("margin-left","90px");
		$("#btt span").eq(4).css("margin-left","120px");
		$("#btt span").eq(5).css("margin-left","150px");
		$("#btt span").eq(6).css("margin-left","180px");
		$("#btt span").eq(7).css("margin-left","210px");
		$("#btt span").eq(8).css("margin-left","240px");
		});